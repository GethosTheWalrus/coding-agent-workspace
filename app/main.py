...
operations, and configures the startup/shutdown events for the database.
"""
...
def update_todo(todo_id: int, todo: schemas.TodoUpdate, db: Session = Depends(get_db_session)):
